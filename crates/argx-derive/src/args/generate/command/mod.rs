...
fn value_schema(field: &model::Field, facade: &TokenStream) -> TokenStream {
    match field.binding.value.as_ref().map(|binding| binding.schema) {
        ...
        Some(model::ValueSchema::I8) => quote!(#facade::__private::ValueSchema::I8),
        Some(model::ValueSchema::I16) => quote!(#facade::__private::ValueSchema::I16),
        Some(model::ValueSchema::I32) => quote!(#facade::__private::ValueSchema::I32),
        Some(model::ValueSchema::I64) => quote!(#facade::__private::ValueSchema::I64),
        Some(model::ValueSchema::I128) => quote!(#facade::__private::ValueSchema::I128),
        Some(model::ValueSchema::Isize) => quote!(#facade::__private::ValueSchema::Isize),
        Some(model::ValueSchema::U8) => quote!(#facade::__private::ValueSchema::U8),
        Some(model::ValueSchema::U16) => quote!(#facade::__private::ValueSchema::U16),
        Some(model::ValueSchema::U32) => quote!(#facade::__private::ValueSchema::U32),
        Some(model::ValueSchema::U64) => quote!(#facade::__private::ValueSchema::U64),
        Some(model::ValueSchema::U128) => quote!(#facade::__private::ValueSchema::U128),
        Some(model::ValueSchema::Usize) => quote!(#facade::__private::ValueSchema::Usize),
