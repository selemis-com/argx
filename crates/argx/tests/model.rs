...
//! protect composition order, semantic identities, normalized constraints, help metadata, and
//! subcommand tables before parsing begins. Assertions about key layout are implementation
//! invariants of this ABI rather than user-facing CLI semantics; end-to-end binding behavior is
//! covered separately in `parser.rs`.
