...
fn bash_script(command: &str) -> String {
    format!(
        r#"# @generated by argx {version}; regenerate after upgrading argx
...
fn zsh_script(command: &str) -> String {
    format!(
        r#"#compdef {command}
# @generated by argx {version}; regenerate after upgrading argx
_{command}() {{
...
mod tests {
    ...
    fn scripts_use_the_private_protocol_and_register_the_requested_shell() {
        let expected_header = format!(
            "# @generated by argx {}; regenerate after upgrading argx",
            env!("CARGO_PKG_VERSION")
        );

        let bash = render("tool", Shell::Bash).unwrap();
        assert!(bash.starts_with(&expected_header));
        ...
        assert!(fish.starts_with(&expected_header));
        ...
        assert!(zsh.starts_with(&format!("#compdef tool\n{expected_header}\n")));
